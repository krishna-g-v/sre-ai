...
- This behavior is a prompting/retrieval-logic requirement on `sre-ai-backend`, not a storage-layer concern — §3 just determines what chunk granularities exist to choose from.
